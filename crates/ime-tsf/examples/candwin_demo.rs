//! 候选窗演示程序（契约 14-mod-ime-tsf-candwin.md §3）。
//! 运行：`cargo run -p ime-tsf --example candwin_demo`
//!
//! 人眼验收要点：
...
use input_ime_tsf::ui::{CandidateUi, CaretRect, GdiCandidateWindow, UiSnapshot};
...
fn main() {
    println!("Input IME 候选窗演示 —— 按 Esc 退出（建议同时打开记事本观察不抢焦点）");
